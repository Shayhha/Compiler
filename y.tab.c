...
static const yytype_int16 yyrline[] =
{
     ...
     152,   153,   154,   155,   156,   157,   161,   162,   165,   166,
     167,   168,   169,   170,   171,   172,   173,   174,   175,   178,
     179,   183,   184,   186,   187,   191,   193,   201,   209,   217,
     228,   230,   231,   232,   233,   235,   236,   240,   241,   242,
...
yyreduce:
  ...
  case 2: /* program: code  */
#line 37 "Comp.yacc"
               {(yyval.nodeval) = (yyvsp[0].nodeval); printtree((yyval.nodeval), 0); checktree((yyval.nodeval)); printf("\n 🂡 ⧓ ⧖ ⧓ ⧖ ⧓ ⧖ ⧔  Semantic Checks Passed! ⧕ ⧖ ⧓ ⧖ ⧓ ⧖ ⧓ 🂡\n"); printf("\n 🂡 ⧓ ⧖ ⧓ ⧖ ⧓ ⧖ ⧔  Created 3-Address-Code successfuly! 🐱‍🚀 ⧕ ⧖ ⧓ ⧖ ⧓ ⧖ ⧓ 🂡\n\n");}
#line 1731 "y.tab.c"
    break;
